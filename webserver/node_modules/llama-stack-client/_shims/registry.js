...
function setShims(shims, options = { auto: false }) {
    if (exports.auto) {
        throw new Error(`you must \`import 'llama-stack-client/shims/${shims.kind}'\` before importing anything else from llama-stack-client`);
    }
    if (exports.kind) {
        throw new Error(`can't \`import 'llama-stack-client/shims/${shims.kind}'\` after \`import 'llama-stack-client/shims/${exports.kind}'\``);
    }
