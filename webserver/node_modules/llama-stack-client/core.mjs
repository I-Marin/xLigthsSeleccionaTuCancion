...
import { LlamaStackClientError, APIError, APIConnectionError, APIConnectionTimeoutError, APIUserAbortError, } from "./error.mjs";
...
export class APIClient {
    ...
    stringifyQuery(query) {
        return Object.entries(query)
            ...
            throw new LlamaStackClientError(`Cannot stringify type ${typeof value}; Expected string, number, boolean, or null. If you need to pass nested query parameters, you can manually encode them, e.g. { query: { 'foo[key1]': value1, 'foo[key2]': value2 } }, and please open a GitHub issue requesting better support for your use case.`);
        })
            .join('&');
    }
...
export class AbstractPage {
    ...
    async getNextPage() {
        ...
        if (!nextInfo) {
            throw new LlamaStackClientError('No next page expected; please check `.hasNextPage()` before calling `.getNextPage()`.');
        }
